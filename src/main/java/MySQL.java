...
public class MySQL {
    ...
    public String getOpciones (int idpregunta) {
        ...
        ResultSet resultadoQuery;
        StringBuilder salidaConsulta= new StringBuilder();
        try (PreparedStatement preParacionQuery = CONNECTION.prepareStatement(query)) {
            ...
            while (resultadoQuery.next()) {
                ...
                salidaConsulta.append(letra).append(".").append(textpOpcion).append("¡");
        ...
        return salidaConsulta.toString();
     ...
     * @param jugador entrad del objeto jugador
     */
    ...
    public String getHistorico() {
        ...
        try (PreparedStatement preParacionQuery = CONNECTION.prepareStatement(query)) {
            ...
            while (resultadoQuery.next()) {
                ...
                salidaConsulta.append("Nombre: ").append(nombreJugador).append(" Puntaje: ").append(puntos).append("¡");
